...
export const steps = [
  ...
  { id: "texto_biblico", questionKey: "form.texto_biblico", type: "multilang", required: true },
  ...
  // 👗 Dress Code
  { id: "codigo_vestimenta", questionKey: "form.codigo_vestimenta", type: "multilang", required: false },
  { id: "recomendaciones_vestimenta", questionKey: "form.recomendaciones_vestimenta", type: "multilang", required: false },
  { id: "link_pinterest_vestimenta", questionKey: "form.link_pinterest_vestimenta", type: "url", required: false },
  { id: "restricciones_vestimenta", questionKey: "form.restricciones_vestimenta", type: "multilang", required: false },
  ...
  { id: "detalle_transferencia", questionKey: "form.detalle_transferencia", type: "multilang", required: true, condition: (answers) => answers["tipo_regalo"] === "Transferencia bancaria" },
  { id: "tienda_lista_regalos", questionKey: "form.tienda_lista_regalos", type: "multilang", required: true, condition: (answers) => answers["tipo_regalo"] === "Lista de regalos" },
  { id: "detalle_otro_regalo", questionKey: "form.detalle_otro_regalo", type: "multilang", required: true, condition: (answers) => answers["tipo_regalo"] === "Otro" },
  { id: "texto_regalo", questionKey: "form.texto_regalo", type: "multilang", required: false },
