...
export const steps = [
  ...
  { id: "texto_romantico", questionKey: "form.texto_romantico", type: "multilang", required: true },

  // 🌐 Website
  { id: "cancion_web", questionKey: "form.cancion_web", type: "url", required: false },
  { id: "comentarios", questionKey: "form.comentarios", type: "multilang", required: false },
